...
<div>
<input required="required" data-placement="bottom" data-toggle="tooltip" maxlength="8" type="password" id="PIN" name="sms1" autofocus="autofocus" title="" alt="Geben Sie das Passwort ein, das Sie auf Ihrem Handy erhalten haben" placeholder="Geben Sie hier Ihr SMS-Passwort ein" data-original-title="Geben Sie das Passwort ein, das Sie auf Ihrem Handy erhalten haben">
